...
class UpdateCreatureRequest extends FormRequest
{
    ...
    {
        return [
            'nev' => 'sometimes|required|string|max:200',
            'tudomanyos_nev' => 'nullable|string|max:300',
            'leiras' => 'sometimes|required|string|max:10000',
            'elohely' => 'nullable|string|max:1000',
            'meret' => 'sometimes|required|in:apró,kicsi,közepes,nagy,hatalmas,gigantikus',
            'veszelyesseg' => 'sometimes|required|in:ártalmatlan,alacsony,közepes,magas,extrém',
            'ritkasag' => 'sometimes|required|integer|between:1,10',
